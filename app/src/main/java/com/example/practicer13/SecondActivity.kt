package com.example.practicer13
...
class SecondActivity : AppCompatActivity() {
    ...
    fun ButtonClick (view: View) {
        ...
        if (edt1.text.toString() == "" && edt2.text.toString() == "" || edt1.text.toString() == "" || edt2.text.toString() == "") {
            Toast.makeText(this@SecondActivity, "введите значения", Toast.LENGTH_SHORT).show()
        } else {
            b5.setOnClickListener{
                ...
                var cd : Double = Math.sqrt(Math.pow(c,2.0) + Math.pow(d,2.0))
            ...
            b3.setOnClickListener{
                ...
                var cd : Double = Math.sqrt(Math.pow(c,2.0) + Math.pow(d,2.0))* c * d
